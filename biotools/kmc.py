...
# TODO: Add docstrings to code, documentation to README.
...
def kmc(forward_in, database_name, min_occurrences=1, reverse_in='NA', k=31, cleanup=True, tmpdir='tmp', **kwargs):
    """
...
def percentage_in(query_database, reference_database, intdb='intersection',
                  int_dump='intersection_dumped', ref_dump='reference_dumped', tmpdir='tmp', cleanup=True):
    if not os.path.isdir(tmpdir):
        os.makedirs(tmpdir)
